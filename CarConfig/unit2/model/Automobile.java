...
public class Automobile implements Serializable {
	...
	public void setOpsets(int size, String[] name, String[][] opsets) throws AutoException {
	...
	public boolean updateOptionPrice(String optionSetName, String optionName, float newPrice) {
		try {
			findOpsetByName(optionSetName).findOptionByName(optionName).setPrice(newPrice);
			return true;
		} catch (NullPointerException e) {
			return false;
		}
